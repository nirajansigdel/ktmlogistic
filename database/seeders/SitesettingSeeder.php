...
class SitesettingSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('site_settings')->insert([
            'office_name' => 'KTM Nepal Logistics',
            'office_address' => 'Tinkune,Kathmandu',
            'office_contact' => '9779842967713',
            'office_email' => 'info@ktmnepalogistic.com',
            'whatsapp_number' => '977989842967713',
