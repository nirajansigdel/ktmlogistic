...
<style>
    ...
    .copyright-area {
        background: linear-gradient(135deg, #081c47 0%, #13204a 100%);
        padding: 25px 0;
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <div class="footer-social-icon mt-4">
                    ...
                    <a href="{{ $sitesetting->facebook_link ?? '#' }}" target="_blank" title="Facebook"><i class="fa-brands fa-facebook"></i></a>
                    <a href="{{ $sitesetting->x_link ?? $sitesetting->twitter_link ?? '#' }}" target="_blank" title="X (Twitter)"><i class="fa-brands fa-x-twitter"></i></a>
                    <a href="{{ $sitesetting->instagram_link ?? '#' }}" target="_blank" title="Instagram"><i class="fa-brands fa-instagram"></i></a>
                    <a href="{{ $sitesetting->youtube_link ?? '#' }}" target="_blank" title="YouTube"><i class="fa-brands fa-youtube"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="contact-value"><a href="mailto:{{ $sitesetting->office_email ?? 'contact@example.com' }}">{{ $sitesetting->office_email ?? 'contact@example.com' }}</a></div>
                </div>

                <div class="mb-4">
                    <div class="contact-title">Phone</div>
                    <div class="contact-value"><a href="tel:{{ $sitesetting->office_contact ?? '+1 000 000 0000' }}">{{ $sitesetting->office_contact ?? '+1 000 000 0000' }}</a></div>
                </div>
...
<div class="copyright-area">
    <div class="container text-center">
        <p>
            Copyright © 2024,
            All Rights Reserved {{ $sitesetting->office_name }} <br>
